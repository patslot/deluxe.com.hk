export default function($timeout, $scope, $attrs, $window, gqModel, c, queryHandler) {
  ...
  var listCategArticle = c.TAG_TO_LIST_ARTICLE_API[categEname] + "ByTag";
  var query = null;
  ...
  if (categName === 'Editor picks') {
    ...
    query = function(offset, count) {
      return gqModel.querySubCateg(listCategArticle, subCateg ,offset, count);
    };
